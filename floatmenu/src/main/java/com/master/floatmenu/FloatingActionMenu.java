...
import com.master.floatmenu.animation.DefaultAnimationHandler;
import com.master.floatmenu.animation.MenuAnimationHandler;
...
//        this.mainActionView.setOnClickListener(new ActionViewClickListener());
    ...
    public View getActivityContentView() {
        try {
            return mainActionView.getRootView();
