...
import com.test.screenrecord.encoder.Mp4toGIFConverter;
...
public class VideoEditedRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ActionMode.Callback mActionModeCallback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            videosListFragment.setEnableSwipe(false);
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            isMultiSelect = false;
            videosListFragment.setEnableSwipe(true);
            notifyDataSetChanged();
        }
    };

    public VideoEditedRecyclerAdapter(Context context, ArrayList<Video> android, VideosEditedListFragment videosListFragment) {
        this.videos = android;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case VIEW_SECTION:
                ...
                return new VideoEditedRecyclerAdapter.SectionViewHolder(view);
            case VIEW_ITEM:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.content_video, viewGroup, false);
                return new VideoEditedRecyclerAdapter.ItemViewHolder(view);
            default:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.content_video, viewGroup, false);
                return new VideoEditedRecyclerAdapter.ItemViewHolder(view);
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (holder.getItemViewType()) {
            case VIEW_ITEM:
                final VideoEditedRecyclerAdapter.ItemViewHolder itemViewHolder = (VideoEditedRecyclerAdapter.ItemViewHolder) holder;
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    ...
                                    case R.id.edit:
                                        ...
                                        editIntent.putExtra(Const.VIDEO_EDIT_URI_KEY, Uri.fromFile(video.getFile()).toString());
                ...
                break;
            case VIEW_SECTION:
                VideoEditedRecyclerAdapter.SectionViewHolder sectionViewHolder = (VideoEditedRecyclerAdapter.SectionViewHolder) holder;
    ...
    private String generateSectionTitle(Date date) {
        Calendar sDate = Utils.toCalendar(new Date().getTime());
        Calendar eDate = Utils.toCalendar(date.getTime());
